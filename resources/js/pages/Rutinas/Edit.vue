...
const form = useForm({
    socio_id: props.rutina.socio_id,
    instructor_id: props.rutina.instructor_id,
    ejercicio: props.rutina.ejercicio,
    series: props.rutina.series,
    repeticiones: props.rutina.repeticiones,
});
...
const submit = () => {
    form.put(`/rutinas/${props.rutina.id}`, {
        ...
        onError: () => {
            errorAlert({
                title: 'Error',
                text: 'Hubo un problema al actualizar la rutina',
            });
        },
    });
};
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Actualiza la información de la rutina</CardDescription>
                    </CardHeader>
                    <CardContent>
