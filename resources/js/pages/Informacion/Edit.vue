...
import { index as informacionIndex, update as informacionUpdate } from '@/routes/informacion';
...
const submit = () => {
    form.put(informacionUpdate.url(), {
        onSuccess: () => {
            successAlert({
                title: '¡Actualizado!',
            ...
            <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
                <div class="mb-4">
                    <Button variant="ghost" size="sm" as-child>
                        <Link :href="informacionIndex.url()">
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="flex justify-end gap-3">
                                <Button type="button" variant="outline" as-child>
                                    <Link :href="informacionIndex.url()">Cancelar</Link>
                                </Button>
